 ...
 *
 * The default widget is [ImageWidget](doc:ImageWidget). This widget does not upload immediately - instead a
 * `File` object will be available in the submit data. It is up to you to handle uploading.
 *
 * @wide
 */
            ...
            >
                <div className="grid grid-cols-1 gap-4 w-full">
                    <Form onSubmit={data => console.log(data)}>
                        <Form.Item field={ExampleModel.fields.profileImage} />

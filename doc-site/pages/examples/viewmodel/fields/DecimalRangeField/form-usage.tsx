 ...
 *
 * The default widget is [DecimalRangeWidget](doc:DecimalRangeWidget).
 *
 * You can pass options for the widget via the [DecimalField](doc:DecimalField) under the `boundsFieldProps.widgetProps`
 * option.
 *
 * @wide
 */
            ...
            >
                <div className="grid grid-cols-1 gap-4 w-full">
                    <Form onSubmit={data => console.log(data)}>
                        <Form.Item field={ExampleModel.fields.decimalRange} />

...
The UI package is concerned with providing high level components and a standard interface for customising form widgets
and field formatters throughout the system. It doesn't provide any concrete implementations of the UI. Using the interfaces
...
[FieldWidget](doc:FieldWidget) resolves the UI specific widget to use for a [Field](doc:Field).
